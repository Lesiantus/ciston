...
class Land(models.Model):
    ...
    picture_little = models.ImageField('первая маленькая картинка, вторая сноска', upload_to='ecoc/photos/')
    text3 = models.TextField('надпись второй сноски2')
    picture_little1 = models.ImageField('вторая маленькая картинка, вторая сноска', upload_to='ecoc/photos/')
    text4 = models.TextField('надпись второй сноски2')
    picture_little2 = models.ImageField('третья маленькая картинка, вторая сноска', upload_to='ecoc/photos/')
